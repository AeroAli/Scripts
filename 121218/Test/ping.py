...
if __name__ == "__main__":
	for host in hosts:
		...
		with open("/root/Desktop/121218/Test/Results/" + host + "/users.txt", "w") as file:
			results[host] = {"users": enumUsers(host)}
			for index,user in enumerate(results[host]["users"]):
				file.write(str(user)  + "\n")
		with open("/root/Desktop/121218/Test/Results/" + host + "/rid.txt", "w") as file:
			results[host] = {"users": enumUsers(host)}
			for index,user in enumerate(results[host]["users"]):
				file.write(str(results[host]["users"][user]["rid"])  + "\n")
		with open("/root/Desktop/121218/Test/Results/" + host + "/sid.txt", "w") as file:
			results[host] = {"users": enumUsers(host)}
			for index,user in enumerate(results[host]["users"]):
		...
		with open("/root/Desktop/121218/Test/Results/" + host + "/rid.txt", "w") as file:
			...
			for index,user in enumerate(results[host]["users"]):
				file.write(str(results[host]["users"][user]["sid"])  + "\n")
		with open("/root/Desktop/121218/Test/Results/" + host + "/raw.txt", "w") as file:
			results[host] = {"users": enumUsers(host)}
			for index,user in enumerate(results[host]["users"]):
